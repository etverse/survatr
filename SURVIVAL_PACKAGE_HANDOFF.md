...
| 7 | ✅ | [CHUNK_7_COMPETING_RISKS.md](CHUNK_7_COMPETING_RISKS.md) | Competing risks: parallel cause-specific hazards + CIF contrast + sandwich via stacked EE across cause-specific models. Validated vs closed-form CIF, Aalen–Johansen, `delicatessen` (~1e-4), bootstrap. gcomp / Track A only; Fine–Gray out of scope. | 2, 3 |
