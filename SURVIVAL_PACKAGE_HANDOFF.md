...
| 10 | ✅ TBD | [CHUNK_10_DIAGNOSE.md](CHUNK_10_DIAGNOSE.md) | Survival-aware `diagnose()`: five panels (`positivity`, `balance`, `weights`, `censoring`, `competing`), `survatr_diag` S3 + `print` method. Flags h < 0.001 / h > 0.999; CR identity `Σ F^(j) + S = 1`; IPW weight ESS. | 2, 5, 7 |
